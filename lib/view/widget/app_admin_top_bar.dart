  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        Row(
          children: [
            Obx(() => _buildTab('모두', totalCount, onTapAll, 0, controller.selectedIndex.value)),
            _divider(),
            Obx(() => _buildTab('발행됨', publishedCount, onTapPublished, 1, controller.selectedIndex.value)),
            _divider(),
            Obx(() => _buildTab('대기중', pendingCount, onTapPending, 2, controller.selectedIndex.value)),
          ],
        ),
...
Row(
  children: [
    ...
    SizedBox(
      ...
      child: OutlinedButton(
        ...
        child: Text(
          '글 검색',
          style: AppTextStyle.koSemiBold16().copyWith(color: AppColor.primary),
  ...
  Widget _buildTab(String label, int count, VoidCallback? onTap, int index, int selectedIndex) {
    return InkWell(
      onTap: onTap,
      child: Text(
        '$label ($count)',
